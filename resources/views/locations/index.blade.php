...
<div class="card shadow-lg rounded card-bg">
    ...
    <div class="card-body">
        ...
        <a href="{{ url('/locations/create') }}" class="btn btn-add-user mb-3" title="Add New Location">
                ...
                <tbody>
                    @foreach($locations as $item)
                        <tr>
                            ...
                            <td>
                                <!-- View Button -->
                                <a href="{{ url('/locations/' . $item->id) }}" title="View Location">
                                ...
                                <!-- Edit Button -->
                                <a href="{{ url('/locations/' . $item->id . '/edit') }}" title="Edit Location">
