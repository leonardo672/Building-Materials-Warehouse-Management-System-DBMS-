    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <!-- Navigation Items -->
                <li class="nav-item"><a class="nav-link" href="{{ url('/users') }}"><i class="fas fa-users"></i> Users</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('/locations') }}"><i class="fas fa-user-friends"></i> Locations</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('/materials') }}"><i class="fas fa-cogs"></i> Materials</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('/orders') }}"><i class="fas fa-tag"></i> Orders</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('/suppliers') }}"><i class="fas fa-box"></i> Suppliers</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('/categories') }}"><i class="fas fa-box"></i> Categories</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('/transactions') }}"><i class="fas fa-shopping-cart"></i> Transactions</a></li>
                <!-- Google Translate -->
                <li class="nav-item">
