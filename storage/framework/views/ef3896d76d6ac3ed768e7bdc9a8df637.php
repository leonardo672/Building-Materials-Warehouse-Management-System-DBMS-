...
<div class="card shadow-lg rounded card-bg">
    <div class="card-header header-bg">
        <h2><i class="fa fa-list-alt"></i> Suppliers Management</h2>
    </div>

    <div class="card-body">
        <!-- Button to Add New Supplier -->
        <a href="<?php echo e(url('/suppliers/create')); ?>" class="btn btn-add-user mb-3" title="Add New Supplier">
             <i class="fa fa-plus-circle" aria-hidden="true" style="margin-right: 5px;"></i> Add New Supplier
        </a>
        <br/>
                ...
                <tbody>
                    <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <!-- View Button -->
                                <a href="<?php echo e(url('/suppliers/' . $item->id)); ?>" title="View Supplier">
                                ...
                                <!-- Edit Button -->
                                <a href="<?php echo e(url('/suppliers/' . $item->id . '/edit')); ?>" title="Edit Supplier">
                                ...
                                <!-- Delete Button -->
                                <form method="POST" action="<?php echo e(url('/suppliers/' . $item->id)); ?>" accept-charset="UTF-8" style="display:inline">
                                    <?php echo e(method_field('DELETE')); ?>

                                    <?php echo e(csrf_field()); ?>

                                    <button type="submit" class="btn btn-delete btn-sm" title="Delete Supplier" onclick="return confirm('Are you sure you want to delete this supplier?')">
