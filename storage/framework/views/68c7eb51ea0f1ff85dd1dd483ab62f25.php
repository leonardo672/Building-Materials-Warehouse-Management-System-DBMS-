...
<div class="card">
  ...
  <div class="card-body">
    ...
    <?php if(isset($material)): ?>
        ...
        <h5 class="card-title">Material Name: <?php echo e($material->name); ?></h5>

        <!-- Display Material Description -->
        <p class="card-text">Description: <?php echo e($material->description); ?></p>

        <!-- Display Material Category -->
        <p class="card-text">Category: <?php echo e($material->category->name); ?></p>

        <!-- Display Material Stock Quantity -->
        <p class="card-text">Stock Quantity: <?php echo e($material->stock_quantity); ?></p>

        <!-- Display Material Stock Threshold -->
        <p class="card-text">Stock Threshold: <?php echo e($material->stock_threshold); ?></p>

        <!-- Display Material Price Per Unit -->
        <p class="card-text">Price Per Unit: $<?php echo e(number_format($material->price_per_unit, 2)); ?></p>

        <!-- Display Material Location -->
        <p class="card-text">Location: <?php echo e($material->location->name); ?></p>
    <?php else: ?>
