...
<div class="card shadow-lg rounded card-bg">
    <div class="card-header header-bg">
        <h2><i class="fa fa-list-alt"></i> User Management</h2>
    </div>

    <div class="card-body">
        <!-- Button to Add New User -->
        <a href="<?php echo e(url('/users/create')); ?>" class="btn btn-add-user mb-3" title="Add New User">
                ...
                <tbody>
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <!-- View Button -->
                                <a href="<?php echo e(url('/users/' . $item->id)); ?>" title="View User">
                                ...
                                <!-- Edit Button -->
                                <a href="<?php echo e(url('/users/' . $item->id . '/edit')); ?>" title="Edit User">
