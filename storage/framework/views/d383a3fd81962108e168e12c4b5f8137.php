...
<div class="card shadow-lg rounded card-bg">
    ...
    <div class="card-body">
        ...
        <a href="<?php echo e(route('materials.create')); ?>" class="btn btn-add-user mb-3" title="Add New Material">
                ...
                <tbody>
                    <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($item->category->name); ?></td> <!-- Assuming `category` is a relation -->
                            <td><?php echo e($item->stock_quantity); ?></td>
                            <td><?php echo e(number_format($item->price_per_unit, 2)); ?></td> <!-- Formatted Price -->
                            <td>
                                <!-- View Button -->
                                <a href="<?php echo e(route('materials.show', $item->id)); ?>" title="View Material">
                                ...
                                <!-- Edit Button -->
                                <a href="<?php echo e(route('materials.edit', $item->id)); ?>" title="Edit Material">
                                ...
                                <!-- Delete Button -->
                                <form method="POST" action="<?php echo e(route('materials.destroy', $item->id)); ?>" accept-charset="UTF-8" style="display:inline">
                                    <?php echo csrf_field(); ?>
