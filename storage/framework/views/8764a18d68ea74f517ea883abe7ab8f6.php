...
<div class="card shadow-lg rounded card-bg">
    ...
    <div class="card-body">
        ...
        <a href="<?php echo e(url('/orders/create')); ?>" class="btn btn-add-user mb-3" title="Add New Order">
                ...
                <tbody>
                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($order->material->name); ?></td>
                            <td><?php echo e($order->quantity); ?></td>
                            <td>
                                $<?php echo e(number_format($order->quantity * $order->material->price_per_unit, 2)); ?>

                            </td>
                            <td><?php echo e(ucfirst($order->status)); ?></td>
                            <td>
                                <!-- View Button -->
                                <a href="<?php echo e(url('/orders/' . $order->id)); ?>" title="View Order">
                                ...
                                <!-- Edit Button -->
                                <a href="<?php echo e(url('/orders/' . $order->id . '/edit')); ?>" title="Edit Order">
                                ...
                                <!-- Delete Button -->
                                <form method="POST" action="<?php echo e(url('/orders/' . $order->id)); ?>" accept-charset="UTF-8" style="display:inline">
