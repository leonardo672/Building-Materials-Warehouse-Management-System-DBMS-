...
<div class="card shadow-lg rounded card-bg">
    ...
    <div class="card-body">
        ...
        <a href="<?php echo e(url('/categories/create')); ?>" class="btn btn-add-user mb-3" title="Add New Category">
                ...
                <tbody>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <!-- View Button -->
                                <a href="<?php echo e(url('/categories/' . $category->id)); ?>" title="View Category">
                                ...
                                <!-- Edit Button -->
                                <a href="<?php echo e(url('/categories/' . $category->id . '/edit')); ?>" title="Edit Category">
                                ...
                                <!-- Delete Button -->
                                <form method="POST" action="<?php echo e(url('/categories/' . $category->id)); ?>" accept-charset="UTF-8" style="display:inline">
